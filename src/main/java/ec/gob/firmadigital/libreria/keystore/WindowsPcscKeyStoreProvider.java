...
public class WindowsPcscKeyStoreProvider extends PKCS11KeyStoreProvider {
    ...
    public String getCfg() {
        return is64bit() ? System.getProperty("user.home") + "/cfg/WindowsPcscKeyStoreProvider64Bits.cfg" : System.getProperty("user.home") + "/cfg/WindowsPcscKeyStoreProvider32Bits.cfg";
    }
}
