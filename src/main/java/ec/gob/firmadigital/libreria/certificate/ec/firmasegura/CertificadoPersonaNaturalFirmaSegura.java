...
/**
 * Certificado de Persona Natural emitido por Firmasegura S.A.S.
 *
 * @author Mauricio Perez <mauricio.perez@firmaseguraec.com>
 */
public class CertificadoPersonaNaturalFirmaSegura extends CertificadoFirmaSegura
        implements CertificadoPersonaNatural {

    public CertificadoPersonaNaturalFirmaSegura(X509Certificate certificado) {
        super(certificado);
    }
