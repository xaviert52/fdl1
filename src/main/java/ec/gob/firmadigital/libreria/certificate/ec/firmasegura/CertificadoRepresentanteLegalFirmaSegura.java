...
/**
 * Certificado de Representante Legal emitido por Firmasegura S.A.S.
 *
 * @author Mauricio Perez <mauricio.perez@firmaseguraec.com>
 */
public class CertificadoRepresentanteLegalFirmaSegura extends CertificadoFirmaSegura
        implements CertificadoRepresentanteLegal {

    public CertificadoRepresentanteLegalFirmaSegura(X509Certificate certificado) {
        super(certificado);
    }
