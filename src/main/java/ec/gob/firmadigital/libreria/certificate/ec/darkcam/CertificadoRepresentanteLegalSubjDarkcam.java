...
/**
 * Certificado de Representante Legal emitido por DARKCAM S.A.
 *
 * @author DARKCAM S.A.
 */
public class CertificadoRepresentanteLegalSubjDarkcam extends CertificadoSubjDarkcamImpl
        implements CertificadoRepresentanteLegal {

    public CertificadoRepresentanteLegalSubjDarkcam(X509Certificate certificado) {
        super(certificado);
    }
