...
/**
 * Certificado de Persona Juridica emitido por CorpNewBest.
 *
 * @author Pedro Reyes
 */
public class CertificadoPersonaJuridicaCorpNewBest extends CertificadoCorpNewBest
        implements CertificadoPersonaJuridica {

    public CertificadoPersonaJuridicaCorpNewBest(X509Certificate certificado) {
        super(certificado);
    }
