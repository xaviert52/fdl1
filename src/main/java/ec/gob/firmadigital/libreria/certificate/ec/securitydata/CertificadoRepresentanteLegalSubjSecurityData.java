...
import static ec.gob.firmadigital.libreria.certificate.CertificadoOids.Subj.OID_CARGO;
import static ec.gob.firmadigital.libreria.certificate.CertificadoOids.Subj.OID_ORGANIZACION;
 ...
 */
public class CertificadoRepresentanteLegalSubjSecurityData extends CertificadoSubjSecurityDataImpl
        implements CertificadoRepresentanteLegal {

    public CertificadoRepresentanteLegalSubjSecurityData(X509Certificate certificado) {
        super(certificado);
    }
