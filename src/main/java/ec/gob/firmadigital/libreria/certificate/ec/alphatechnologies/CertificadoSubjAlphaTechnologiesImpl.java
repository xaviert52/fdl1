...
/**
 * Certificado emitido por Alpha Technologies Cia. Ltda. y que sigue la
 * estructura de la resolucion de ARCOTEL.
 *
 * @author Alpha Technologies Cia. Ltda.
 */
public class CertificadoSubjAlphaTechnologiesImpl extends Certificado {

    public CertificadoSubjAlphaTechnologiesImpl(X509Certificate certificado) {
        super(certificado);
