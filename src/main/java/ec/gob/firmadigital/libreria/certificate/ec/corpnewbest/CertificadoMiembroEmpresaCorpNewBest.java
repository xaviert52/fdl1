...
/**
 * Certificado de Miembro de Empresa emitido por CorpNewBest.
 *
 * @author Pedro Reyes
 */
public class CertificadoMiembroEmpresaCorpNewBest extends CertificadoCorpNewBest
        implements CertificadoMiembroEmpresa {

    public CertificadoMiembroEmpresaCorpNewBest(X509Certificate certificado) {
        super(certificado);
    }
