...
/**
 * Certificado de Persona Natural emitido por CorpNewBest.
 *
 * @author Pedro Reyes
 */
public class CertificadoPersonaNaturalCorpNewBest extends CertificadoCorpNewBest
        implements CertificadoPersonaNatural {

    public CertificadoPersonaNaturalCorpNewBest(X509Certificate certificado) {
        super(certificado);
    }
