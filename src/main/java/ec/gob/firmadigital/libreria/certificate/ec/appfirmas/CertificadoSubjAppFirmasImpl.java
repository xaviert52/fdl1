...
/**
 * Certificado emitido por AppFimras y que sigue la estructura de la resolucion
 * de ARCOTEL.
 *
 * @author AppFimras
 */
public class CertificadoSubjAppFirmasImpl extends Certificado {

    public CertificadoSubjAppFirmasImpl(X509Certificate certificado) {
        super(certificado);
