...
/**
 * Certificado de Representante Legal emitido por Alpha Technologies Cia. Ltda.
 *
 * @author Alpha Technologies Cia. Ltda.
 */
public class CertificadoRepresentanteLegalSubjAlphaTechnologies extends CertificadoSubjAlphaTechnologiesImpl
        implements CertificadoRepresentanteLegal {

    public CertificadoRepresentanteLegalSubjAlphaTechnologies(X509Certificate certificado) {
        super(certificado);
    }
