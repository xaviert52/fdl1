...
/**
 * Certificado de Miembro Empresa / Sello Electrónico emitido por DARKCAM S.A.
 *
 * @author DARKCAM S.A.
 */
public class CertificadoSelloElectronicoSubjDarkcam extends CertificadoSubjDarkcamImpl
        implements CertificadoMiembroEmpresa {

    public CertificadoSelloElectronicoSubjDarkcam(X509Certificate certificado) {
        super(certificado);
    }
