 ...
 */
public class CertificadoMiembroEmpresaSubjAlphaTechnologies extends CertificadoSubjAlphaTechnologiesImpl
        implements CertificadoMiembroEmpresa {

    public CertificadoMiembroEmpresaSubjAlphaTechnologies(X509Certificate certificado) {
        super(certificado);
    }
