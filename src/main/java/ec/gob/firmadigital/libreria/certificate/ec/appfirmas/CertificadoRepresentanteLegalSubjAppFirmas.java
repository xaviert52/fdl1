...
/**
 * Certificado de Representante Legal emitido por AppFirmas
 *
 * @author AppFirmas
 */
public class CertificadoRepresentanteLegalSubjAppFirmas extends CertificadoSubjAppFirmasImpl
        implements CertificadoRepresentanteLegal {

    public CertificadoRepresentanteLegalSubjAppFirmas(X509Certificate certificado) {
        super(certificado);
    }
